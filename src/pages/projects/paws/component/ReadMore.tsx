  ...
  return (
    <div className="max-w-7xl mx-auto py-8 md:py-16 px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <motion.a
          href="/tranzakt"
          className="bg-[#01AC4C] relative w-full h-64 md:h-98 rounded-[17px] shadow-md overflow-hidden px-6 pt-6 md:px-6 md:pt-10 cursor-pointer"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.35 }}
          viewport={{ once: true }}
        ...
        >
          <div className="w-full">
            <motion.img
              src="/images/read-more-tranzakt.png"
              alt="Capalyze"
              className="w-full object-cover"
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
          ...
          <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black via-black to-transparent p-4 md:p-6 md:pt-20">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Tranzakt is a fintech platform built to make payments,
